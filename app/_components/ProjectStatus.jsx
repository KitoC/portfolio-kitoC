...
const ProjectStatus = ({ status }) => {
  ...
  return (
    <div className="relative z-0">
      <div
        className="w-[80px] h-[40px] rounded-full relative z-10 border-2 border-slate-300"
        style={{ borderRadius: "50%" }}
      >
        <div
          className="w-full h-full rounded-full bg-slate-500  z-10 border-2 border-slate-600 border-l-slate-400 border-b-slate-400 relative"
          style={{ borderRadius: "50%" }}
        >
          <div
            className={clsx(
      ...
      <div
        className="w-[80px] h-[40px] bg-slate-400 border-l-slate-600 border-2 border-slate-500 absolute z-0"
        style={{
          top: "16px",
